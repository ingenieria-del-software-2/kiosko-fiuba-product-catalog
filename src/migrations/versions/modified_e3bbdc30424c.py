"""create_product_catalog_tables_without_slug.

Revision ID: modified_e3bbdc30424c
Revises: populate_product_slugs
Create Date: 2025-04-07 13:20:13.350336
...
revision: str = "modified_e3bbdc30424c"
...
def upgrade() -> None:
    ...
    # Skip slug related operations for categories
    op.drop_constraint("categories_name_key", "categories", type_="unique")

    # Add product fields except slug (already added)
